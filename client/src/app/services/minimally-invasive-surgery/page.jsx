...
function Hero() {
  ...
  const lines = ["Minimally Invasive", "Surgery in", "Bradenton, Florida."];
    ...
    <section ref={ref} className="relative min-h-screen overflow-hidden bg-[#FAF5F1]"
      ...
      <div className="relative z-[1] mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-5 py-24 sm:px-8 md:grid-cols-2 md:gap-10 md:py-32 lg:px-0 lg:py-36">
        <div className="flex flex-col">
          <div className="gh-eyebrow mb-7"><Eyebrow>Minimally Invasive Surgery · Bradenton, FL</Eyebrow></div>
          ...
          <p className="gh-sub mt-6 max-w-[460px] leading-[1.9]"
            ...
            Today we perform a variety of gynecological surgeries through a smaller and much less
            invasive technique. The advances in medicine allow our OBGYN specialists to perform
            minimally invasive procedures in an outpatient or same-day surgical center at Bradenton.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button className="gh-cta" variant="primary" href="/contact">Book an Appointment</Button>
            <Button className="gh-cta" variant="outline" href="tel:9415003100">Call (941) 500-3100</Button>
          </div>
          <div className="mt-8 flex flex-wrap gap-2.5">
            {["Smaller Incisions", "Faster Recovery", "Less Scarring", "Outpatient Procedures"].map((l) => (
        ...
        <div className="gh-image relative">
          ...
          <div className="relative h-[300px] w-full overflow-hidden sm:h-[460px] md:h-[560px] lg:h-[650px]"
            ...
            <Image src="/services/minimally-invasive-hero.jpg" alt="Minimally invasive surgery at Women's Care of Bradenton" fill priority
...
function Benefits() {
  ...
  const benefits = [
    ...
    "Bladder function is better preserved",
    "Faster recovery and return to daily activities",
    "Lower risk of complications",
    "More precise and improved results",
  ];
    ...
    <section ref={ref} className="relative w-full overflow-hidden bg-[#FAF5F1]">
      ...
      <div className="relative z-[1] mx-auto grid max-w-6xl grid-cols-1 items-stretch md:grid-cols-2 md:min-h-[680px]">
        ...
        <div className="relative order-2 h-[340px] overflow-hidden md:order-1 md:h-auto">
          <div className="ben-img-inner absolute inset-[-8%] w-[116%]">
            <Image src="/services/minimally-invasive-consult.jpg" alt="Surgical team performing minimally invasive gynecologic surgery" fill
              sizes="(min-width:768px) 50vw,100vw" className="object-cover" />
          </div>
          ...
          <div className="ben-reveal absolute bottom-6 left-5 max-w-[210px] rounded-2xl p-4 sm:bottom-8 sm:left-7"
            ...
            <div className="mb-1.5 flex items-center gap-1.5">
              ...
              <p className="text-[9.5px] font-bold uppercase tracking-[0.2em]"
                style={{ color: "oklch(0.44 0.1 320)" }}>Advanced technique</p>
            </div>
            <p className="text-[11.5px] leading-[1.7]" style={{ color: "#6F665E" }}>
              Smaller incisions mean less pain and a faster return to the things you love.
            </p>
          </div>
        </div>
        ...
        <div className="order-1 flex flex-col justify-center gap-6 px-7 py-16 md:order-2 md:px-12 md:py-20 lg:px-14">
          <div className="ben-reveal"><Eyebrow>Benefits</Eyebrow></div>
          <h2 className="ben-reveal font-display leading-[1.05] tracking-[-0.026em]"
            ...
            <em style={{ fontStyle: "italic", color: WARM }}>Gynecologic Surgery.</em>
          </h2>
          <div className="ben-reveal relative border-l-2 py-1 pl-5"
            style={{ borderColor: "oklch(0.75 0.08 320 / 0.3)" }}>
            <p className="text-[15px] leading-[1.88]" style={{ color: MUTED }}>
              Today we perform a variety of gynecological surgeries through a smaller and much less
              invasive technique. The advantages to performing minimally invasive gynecological
              surgeries include:
            </p>
          </div>
          <ul className="ben-reveal grid grid-cols-1 gap-2.5 sm:grid-cols-2">
            {benefits.map((b, i) => (
          ...
          <div className="ben-reveal">
            <p className="mb-5 text-[13.5px] leading-[1.8]" style={{ color: MUTED }}>
              Many minimally invasive surgery techniques and procedures can be performed on an
              outpatient basis, meaning you can return home the same day as your surgery.
            </p>
            <Button variant="primary" href="/contact">Request a consultation</Button>
          </div>
        </div>
      </div>
    </section>
...
function SurgeryTypes() {
  ...
  useEffect(() => {
    const el = ref.current;
    if (!el || typeof window === "undefined") return;
    const intro = gsap.utils.toArray(".st-intro > *", el);
    const cells = gsap.utils.toArray(".st-cell", el);
  ...
  return (
    <section ref={ref} className="relative w-full overflow-hidden"
      ...
      <div className="relative z-[1] mx-auto max-w-6xl px-5 py-24 sm:px-8 md:py-28 lg:px-0 lg:py-32">
        <div className="st-intro mb-14 flex flex-col items-center gap-4 text-center">
          <Eyebrow light>Types of surgery</Eyebrow>
          <h2 className="font-display leading-[1.05] tracking-[-0.026em] text-white"
            ...
            <em style={{ fontStyle: "italic", color: PINK_L }}>Gynecologic Surgery.</em>
          </h2>
          <p className="max-w-[540px] text-[15px] leading-[1.88]" style={{ color: "oklch(1 0 0 / 0.58)" }}>
            Women in Bradenton now have a patient-centered approach to minimally invasive
            gynecologic surgery available to them. We offer a variety of procedures to treat
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          {/* Cell A — wide: Laparoscopy */}
          <div className="st-cell group relative overflow-hidden rounded-[24px] p-8 sm:col-span-2 lg:col-span-2"
            ...
            <p className="max-w-[520px] text-[14px] leading-[1.88]" style={{ color: "oklch(1 0 0 / 0.58)" }}>
              This medical procedure uses a narrow tube with a lighted camera to create three to four small
              incisions in the patient's pelvic area. The laparoscope is inserted through the abdominal wall,
              allowing the surgeon to view the pelvic organs and perform a range of surgical procedures with
              greater precision and far less trauma than traditional open surgery.
            </p>
          </div>

          {/* Cell B — tall right: Vaginal Procedure */}
          <div className="st-cell group relative overflow-hidden rounded-[24px] p-7 sm:row-span-2"
            ...
            <p className="text-[13.5px] leading-[1.88]" style={{ color: "oklch(1 0 0 / 0.54)" }}>
              This procedure creates a small incision to assist the vaginal site. The procedure is
              performed through the vagina, eliminating any external incisions entirely. This results
              in no visible scarring and often a quicker recovery time compared to abdominal approaches.
            </p>
          </div>

          {/* Cell C: Laparoscopic-assisted Vaginal */}
          <div className="st-cell group relative overflow-hidden rounded-[24px] p-7"
            ...
            <p className="text-[13px] leading-[1.84]" style={{ color: "oklch(1 0 0 / 0.52)" }}>
              Combines the laparoscopic technique with vaginal access. This approach offers the
              best of both methods — exceptional visualization with no external scarring — and is
              one of the two procedures our team can perform.
            </p>
          </div>

          {/* Cell D: Robot-assisted Surgery */}
          <div className="st-cell group relative overflow-hidden rounded-[24px] p-7"
            style={{ background: "oklch(1 0 0 / 0.05)", border: "1px solid oklch(1 0 0 / 0.09)", boxShadow: "0 2px 8px oklch(0 0 0 / 0.14)", minHeight: "180px" }}>
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-700 group-hover:opacity-100"
            ...
            <div className="my-3 h-px" style={{ background: "oklch(1 0 0 / 0.09)" }} />
            <p className="text-[13px] leading-[1.84]" style={{ color: "oklch(1 0 0 / 0.52)" }}>
              Robotic surgery commands using a surgeon's hand and finger movements, translating
              them with greater precision and range of motion while ensuring each incision is highly
          ...
          <div className="st-cell group relative overflow-hidden rounded-[24px] p-7"
            style={{ background: "oklch(1 0 0 / 0.05)", border: "1px solid oklch(1 0 0 / 0.09)", boxShadow: "0 2px 8px oklch(0 0 0 / 0.14)", minHeight: "180px" }}>
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-700 group-hover:opacity-100"
              style={{ background: "radial-gradient(ellipse at 50% 100%,oklch(0.6 0.1 220 / 0.12),transparent 65%)" }} />
            <span className="mb-5 block text-[11px] font-bold uppercase tracking-[0.22em]"
              style={{ color: "oklch(0.72 0.1 320 / 0.7)" }}>05</span>
            <h3 className="font-display text-[1.2rem] font-semibold leading-snug text-white"
              style={{ fontFamily: "var(--font-display,'Playfair Display',serif)" }}>
              Hysteroscopy
            </h3>
            <div className="my-3 h-px" style={{ background: "oklch(1 0 0 / 0.09)" }} />
            <p className="text-[13px] leading-[1.84]" style={{ color: "oklch(1 0 0 / 0.52)" }}>
              A hysteroscope is inserted through the cervix upward into the uterus to visualise and
              access the entire endometrial cavity without incisions.
            </p>
          </div>

          {/* Cell F: Single-port Surgery */}
          <div className="st-cell group relative overflow-hidden rounded-[24px] p-7"
            style={{ background: "oklch(1 0 0 / 0.05)", border: "1px solid oklch(1 0 0 / 0.09)", boxShadow: "0 2px 8px oklch(0 0 0 / 0.14)", minHeight: "180px" }}>
            <div aria-hidden="true" className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-700 group-hover:opacity-100"
              style={{ background: "radial-gradient(ellipse at 20% 20%,oklch(0.68 0.09 310 / 0.13),transparent 65%)" }} />
            <span className="mb-5 block text-[11px] font-bold uppercase tracking-[0.22em]"
              style={{ color: "oklch(0.72 0.1 320 / 0.7)" }}>06</span>
            <h3 className="font-display text-[1.2rem] font-semibold leading-snug text-white"
              style={{ fontFamily: "var(--font-display,'Playfair Display',serif)" }}>
              Single-port Surgery
            </h3>
            <div className="my-3 h-px" style={{ background: "oklch(1 0 0 / 0.09)" }} />
            <p className="text-[13px] leading-[1.84]" style={{ color: "oklch(1 0 0 / 0.52)" }}>
              The focus performs a laparoscopic gynecology procedure using a single small incision
              through the navel — virtually scarless results and the fastest recovery.
            </p>
          </div>
        </div>
...
// ─── 4. WHY WOMEN'S CARE — editorial numbered list ───────────────────────────
...
function WhyCare() {
  ...
  useEffect(() => {
    const el = ref.current;
    if (!el || typeof window === "undefined") return;
    const heading = gsap.utils.toArray(".wc-head > *", el);
    const rows    = gsap.utils.toArray(".wc-row", el);
    const imgWrap = el.querySelector(".wc-img");
    gsap.set(heading, { opacity: 0, y: 20 });
    gsap.set(rows,    { opacity: 0, y: 22 });
    if (imgWrap) gsap.set(imgWrap, { opacity: 0, x: 40 });
    const base = { ease: "power3.out", scrollTrigger: { trigger: el, start: "top 78%" } };
    ...
    if (imgWrap) {
      const a3 = gsap.to(imgWrap, { opacity: 1, x: 0, duration: 0.95, delay: 0.08, ease: "power3.out", ...base });
  ...
  const items = [
    {
      label: "Expert, Board-Certified Surgeons",
      body: "Dr. Jothi is one of the most highly rated Robotic Surgeons in the Bradenton-Sarasota area, specialising in hysterectomies, fibroid removal, endometriosis, pelvic pain, and cosmetic gynecology.",
    },
    {
      label: "Advanced Technology & Techniques",
      body: "Our practice employs the latest robotic-assisted and laparoscopic platforms — ensuring maximum precision with minimal trauma and the fastest possible return to your daily life.",
    },
    {
      label: "Personalised Surgical Planning",
      body: "Every procedure begins with a detailed consultation. We evaluate your complete health history, discuss every available approach, and select the technique best suited to your anatomy and goals.",
    },
    {
      label: "Same-Day Outpatient Procedures",
      body: "Many of our minimally invasive surgeries are performed on an outpatient basis at our Bradenton surgical center — meaning you can recover in the comfort of your own home.",
    },
    {
      label: "Comprehensive Follow-Up Care",
      body: "Our commitment extends far beyond the operating room. We provide full post-surgical support, monitoring your recovery and available to answer questions at every step.",
    },
  ];
  ...
  return (
    <section ref={ref} className="relative w-full overflow-hidden bg-[#FAF5F1]">
      ...
      <div className="relative z-[1] mx-auto max-w-6xl px-5 py-24 sm:px-8 md:py-28 lg:px-0 lg:py-32">
        ...
        <div className="wc-head mb-16 grid grid-cols-1 gap-8 md:grid-cols-2 md:items-end">
          <div className="flex flex-col gap-4">
            ...
            <h2 className="font-display leading-[1.05] tracking-[-0.026em]"
              ...
              <em style={{ fontStyle: "italic", color: WARM }}>Surgery Center.</em>
            </h2>
          </div>
          <p className="max-w-[360px] text-[14.5px] leading-[1.88] md:ml-auto md:text-right" style={{ color: MUTED }}>
            Women in Bradenton and the surrounding areas deserve access to the most
            advanced surgical care available — delivered with compassion and precision.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-12 md:grid-cols-[1fr_420px]">
          <div className="flex flex-col">
            {items.map((s, i) => (
              <div key={i} className="wc-row group relative grid cursor-default grid-cols-[3rem_1fr] items-start gap-x-6 border-t py-6 transition-all duration-300"
                ...
                <div>
                  ...
                  <p className="mt-2 text-[13px] leading-[1.82]" style={{ color: "#8A817A" }}>
                    {s.body}
                  </p>
                </div>
          ...
          {/* Sticky image */}
          <div className="wc-img hidden md:block">
            <div className="sticky top-28">
              <div className="relative h-[520px] w-full overflow-hidden"
                style={{ borderRadius: "1.5rem 4rem 1.5rem 1.5rem", boxShadow: "0 4px 8px oklch(0.2 0.03 60 / 0.06),0 24px 60px oklch(0.2 0.03 60 / 0.16)" }}>
                <Image src="/services/minimally-invasive-why.jpg"
                  alt="Women's Care of Bradenton surgical team"
                  fill className="object-cover"
                  sizes="420px" />
                <div aria-hidden="true" className="absolute inset-x-0 bottom-0 h-32"
                  style={{ background: "linear-gradient(to top,oklch(0.18 0.04 320 / 0.45),transparent)" }} />
              </div>
              <div className="mt-4 rounded-2xl p-5"
                style={{ background: "rgba(255,255,255,0.8)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", border: "1px solid oklch(0.88 0.04 320 / 0.22)", boxShadow: "0 2px 10px oklch(0.3 0.05 320 / 0.06)" }}>
                <p className="text-[13px] leading-[1.82] italic" style={{ color: MUTED }}>
                  "Minimally invasive gynecology is not just a surgical technique — it is our
                  commitment to helping every woman recover quickly and return to the life she loves."
                </p>
                <p className="mt-3 text-[11px] font-bold uppercase tracking-[0.18em]"
                  style={{ color: "oklch(0.44 0.1 320)" }}>— Dr. Jothivijayarani</p>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <section ref={ref} className="relative w-full overflow-hidden"
      ...
      <div className="cta-inner relative z-[1] mx-auto flex max-w-2xl flex-col items-center gap-5 px-5 py-24 text-center sm:px-8 md:py-28">
        <Eyebrow>Ready to take the next step?</Eyebrow>
        <h2 className="font-display leading-[1.05] tracking-[-0.026em]"
          style={{ fontFamily: "var(--font-display,'Playfair Display',serif)", fontSize: "clamp(1.9rem,3.8vw,3.1rem)", color: DARK }}>
          Contact Women's Care of Bradenton{" "}
          <em style={{ fontStyle: "italic", color: "oklch(0.44 0.13 322)" }}>today.</em>
        </h2>
        <p className="max-w-[460px] text-[15px] leading-[1.88]" style={{ color: MUTED }}>
          If you need a minimally invasive surgery center, reach out to Women's Care of
          Bradenton. Our team is here to guide you every step of the way.
        </p>
