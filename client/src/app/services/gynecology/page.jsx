    ...
    <section ref={ref} className="relative min-h-screen overflow-hidden bg-[#FAF5F1]"
      ...
      <div className="relative z-[1] mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-5 py-24 sm:px-8 md:grid-cols-2 md:gap-10 md:py-32 lg:px-0 lg:py-36">
        <div className="flex flex-col">
          <div className="gh-eyebrow mb-7"><Eyebrow>Gynecology · Bradenton, FL</Eyebrow></div>
          ...
          <p className="gh-sub mt-6 max-w-[460px] leading-[1.9]"
            ...
            Women's Care of Bradenton provides board-certified gynecology —
            from annual exams to advanced minimally invasive surgery — in a warm,
          ...
          <div className="mt-8 flex flex-wrap gap-2.5">
            {["Board Certified OB/GYN", "30+ Years Experience", "Compassionate Care", "Same-Week Appointments"].map((l) => (
        ...
        <div className="gh-image relative">
          ...
          <div className="relative h-[300px] w-full overflow-hidden sm:h-[460px] md:h-[560px] lg:h-[650px]"
            ...
            <Image src="/services/gynecology-hero.jpg" alt="Gynecologist consulting with patient" fill priority
            ...
            <div className="gh-float absolute -bottom-5 -left-4 flex items-center gap-3 rounded-2xl px-4 py-3 sm:-bottom-6 sm:-left-6 sm:px-5 sm:py-4"
              ...
              <div>
                <p className="font-display text-[18px] font-bold leading-none text-[#1C1814]"
                  style={{ fontFamily: "var(--font-display,'Playfair Display',serif)" }}>10,000+</p>
                <p className="mt-0.5 text-[10px] uppercase tracking-[0.2em]" style={{ color: "#9A9490" }}>Patients Cared For</p>
              </div>
            </div>
          </div>
      ...
      <div className="relative z-[1] mx-auto grid max-w-6xl grid-cols-1 items-stretch md:grid-cols-2 md:min-h-[680px]">
        ...
        <div className="relative order-2 h-[340px] overflow-hidden md:order-1 md:h-auto"
          ...
          <div className="wte-img-inner absolute inset-[-8%] w-[116%]">
            <Image src="/services/gynecology-consult.jpg" alt="Doctor and patient in warm consultation" fill
              sizes="(min-width:768px) 50vw,100vw" className="object-cover" />
          </div>
          ...
          <div className="wte-reveal absolute bottom-6 left-5 max-w-[200px] rounded-2xl p-4 sm:bottom-8 sm:left-7"
            ...
            <div className="mb-1.5 flex items-center gap-1.5">
              ...
              <p className="text-[9.5px] font-bold uppercase tracking-[0.2em]"
                style={{ color: "oklch(0.44 0.1 320)" }}>Privacy first</p>
            </div>
            <p className="text-[11.5px] leading-[1.7]" style={{ color: "#6F665E" }}>
              Everything you share stays confidential — your comfort is our priority.
            </p>
          </div>
        </div>
        ...
        <div className="order-1 flex flex-col justify-center gap-6 px-7 py-16 md:order-2 md:px-12 md:py-20 lg:px-14">
          <div className="wte-reveal"><Eyebrow>What to expect</Eyebrow></div>
          <h2 className="wte-reveal font-display leading-[1.05] tracking-[-0.026em]"
            ...
            <em style={{ fontStyle: "italic", color: WARM }}>not a checklist.</em>
          </h2>

          {/* Large editorial divider with pull-quote */}
          <div className="wte-reveal relative border-l-2 py-1 pl-5"
            style={{ borderColor: "oklch(0.75 0.08 320 / 0.3)" }}>
            <p className="text-[15px] leading-[1.88]" style={{ color: MUTED }}>
              Dr. Jothi takes a whole-woman approach — your physical health, emotional wellbeing,
              and life circumstances all matter here. There will be space to discuss:
            </p>
          </div>
          ...
          <div className="wte-reveal flex flex-wrap gap-2">
            {topics.map((t, i) => (
              <span key={i} className="inline-flex items-center rounded-full px-3.5 py-1.5 text-[12px] font-medium"
                style={{ background: "rgba(255,255,255,0.7)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", border: "1px solid oklch(0.86 0.05 320 / 0.28)", color: "#5C5249" }}>
                {t}
              </span>
            ))}
          </div>
          ...
          <div className="wte-reveal">
            <Button variant="primary" href="/contact">Schedule your exam</Button>
          </div>
        </div>
      </div>
    </section>
    ...
    <section ref={ref} className="relative w-full overflow-hidden"
      ...
      <div className="relative z-[1] mx-auto max-w-6xl px-5 py-24 sm:px-8 md:py-28 lg:px-0 lg:py-32">
        ...
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="oa-cell group relative overflow-hidden rounded-[24px] p-8 sm:col-span-2 lg:col-span-2"
            ...
            <p className="max-w-[520px] text-[14px] leading-[1.88]" style={{ color: "oklch(1 0 0 / 0.58)" }}>
              Dual board certification in Family Practice and OB/GYN means Dr. Jothi sees your
              complete health — not just a single complaint. Every visit draws on the full picture
              of who you are and what you need.
            </p>
          </div>

          {/* Cell B — tall right */}
          <div className="oa-cell group relative overflow-hidden rounded-[24px] p-7 sm:row-span-2"
            ...
            <p className="text-[13.5px] leading-[1.88]" style={{ color: "oklch(1 0 0 / 0.54)" }}>
              Appointments are never rushed. You'll leave with your questions answered and a plan
              you feel genuinely confident about — not a stack of pamphlets and a five-minute goodbye.
            </p>
          </div>

          {/* Cell C */}
          <div className="oa-cell group relative overflow-hidden rounded-[24px] p-7"
            ...
            <p className="text-[13px] leading-[1.84]" style={{ color: "oklch(1 0 0 / 0.52)" }}>
              Among the region's most experienced robotic surgeons — smaller incisions,
          ...
          <div className="oa-cell group relative overflow-hidden rounded-[24px] p-7"
            ...
            <div className="my-3 h-px" style={{ background: "oklch(1 0 0 / 0.09)" }} />
            <p className="text-[13px] leading-[1.84]" style={{ color: "oklch(1 0 0 / 0.52)" }}>
              One physician who knows your history and goals across every stage of life — from
...
function Screenings() {
  ...
  const items = [
    { label: "Pelvic Exam",        body: "A thorough routine assessment of your reproductive organs, performed with care and discretion. Findings are discussed openly and acted on promptly." },
    { label: "Pap Smear",          body: "Cervical cancer screening that detects abnormal cell changes early — the most powerful protective tool available, and it takes only minutes." },
    { label: "Breast Exam",        body: "Clinical breast exams check for lumps, discharge, or structural changes — detecting anything that warrants imaging before symptoms appear." },
    { label: "STI Screening",      body: "Confidential, judgment-free screening. A routine part of preventive care, recommended alongside every annual visit." },
    { label: "Urine Analysis",     body: "A simple sample reveals infections, kidney concerns, or early markers — each easily managed when caught at this stage." },
    { label: "Annual Well-Woman",  body: "A full-picture visit covering every relevant screening — tailored to your age, health history, and the stage of life you're in." },
  ];
      ...
      <div className="relative z-[1] mx-auto max-w-6xl px-5 py-24 sm:px-8 md:py-28 lg:px-0 lg:py-32">
        <div className="sc-head mb-16 grid grid-cols-1 gap-8 md:grid-cols-2 md:items-end">
          ...
          <p className="max-w-[360px] text-[14.5px] leading-[1.88] md:ml-auto md:text-right" style={{ color: MUTED }}>
            Preventive care is the most powerful kind. Each exam is performed with
            clinical precision and genuine compassion.
          </p>
        </div>
...
function Testimonials() {
  ...
  const quotes = [
    { q: "I've never felt more comfortable at a doctor's office. Dr. Jothi takes the time to truly listen — I leave every appointment feeling informed and genuinely cared for.", name: "Dolly H.",     when: "Patient since 2019" },
    { q: "After years of being dismissed elsewhere, I finally found a doctor who understood my concerns and gave me real answers. I can't recommend her enough.",              name: "Patricia D.",   when: "Patient since 2021" },
    { q: "The staff is warm, the office is calm, and Dr. Jothi is genuinely brilliant. This is what women's healthcare should feel like.",                                       name: "Vivienne R.",  when: "Patient since 2020" },
    { q: "She's thorough without being rushed, and honest without being cold. I trust her completely with my health.",                                                           name: "Kathleen G.",  when: "Patient since 2018" },
  ];
      ...
      <div className="relative z-[1] mx-auto max-w-6xl px-5 py-24 sm:px-8 md:py-28 lg:px-0 lg:py-32">
        <div className="tq-intro mb-14 flex flex-col items-center gap-4 text-center">
          ...
          <h2 className="font-display leading-[1.05] tracking-[-0.026em] text-white"
            ...
            Trusted by women{" "}
            <em style={{ fontStyle: "italic", color: PINK_L }}>across Bradenton.</em>
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="tq-card relative overflow-hidden rounded-[24px] p-8 lg:col-span-2"
            ...
            <span aria-hidden="true" className="pointer-events-none absolute -top-4 right-5 select-none font-display leading-none"
              style={{ fontFamily: "var(--font-display,'Playfair Display',serif)", fontSize: "9rem", color: "oklch(0.8 0.06 330 / 0.1)", lineHeight: 1 }}>
              "
            </span>
    ...
    <section ref={ref} className="relative w-full overflow-hidden"
      ...
      <div className="cta-inner relative z-[1] mx-auto flex max-w-2xl flex-col items-center gap-5 px-5 py-24 text-center sm:px-8 md:py-28">
        ...
        <h2 className="font-display leading-[1.05] tracking-[-0.026em]"
          ...
          <em style={{ fontStyle: "italic", color: "oklch(0.44 0.13 322)" }}>deserves priority.</em>
        </h2>
        <p className="max-w-[420px] text-[15px] leading-[1.88]" style={{ color: MUTED }}>
