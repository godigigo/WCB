...
function Hero() {
  ...
  const lines = ["Female Infertility", "Treatment in", "Bradenton, FL."];
    ...
    <section ref={ref} className="relative min-h-screen overflow-hidden bg-[#FAF5F1]"
      ...
      <div className="relative z-[1] mx-auto grid max-w-6xl grid-cols-1 items-center gap-12 px-5 py-24 sm:px-8 md:grid-cols-2 md:gap-10 md:py-32 lg:px-0 lg:py-36">
        <div className="flex flex-col">
          <div className="gh-eyebrow mb-7"><Eyebrow>Female Infertility · Bradenton, FL</Eyebrow></div>
          ...
          <p className="gh-sub mt-6 max-w-[460px] leading-[1.9]"
            ...
            If you are struggling to conceive, it's important to visit an infertility clinic in
            Bradenton, FL as soon as possible. Though fertility issues are quite common, you don't
            have to face them alone. The right medical care makes all the difference.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            <Button className="gh-cta" variant="primary" href="/contact">Book a consultation</Button>
            <Button className="gh-cta" variant="outline" href="tel:9415003100">Call (941) 500-3100</Button>
          </div>
          <div className="mt-8 flex flex-wrap gap-2.5">
            {["Compassionate Care", "Board Certified OB/GYN", "Minimally Invasive", "Bradenton & Sarasota"].map((l) => (
        ...
        <div className="gh-image relative">
          ...
          <div className="relative h-[300px] w-full overflow-hidden sm:h-[460px] md:h-[560px] lg:h-[650px]"
            ...
            <Image src="/services/infertility-hero.jpg" alt="Infertility treatment consultation at Women's Care of Bradenton" fill priority
            ...
            <div className="gh-float absolute -bottom-5 -left-4 flex items-center gap-3 rounded-2xl px-4 py-3 sm:-bottom-6 sm:-left-6 sm:px-5 sm:py-4"
              ...
              <div>
                <p className="font-display text-[18px] font-bold leading-none text-[#1C1814]"
                  style={{ fontFamily: "var(--font-display,'Playfair Display',serif)" }}>Compassionate</p>
                <p className="mt-0.5 text-[10px] uppercase tracking-[0.2em]" style={{ color: "#9A9490" }}>Expert fertility care</p>
              </div>
            </div>
          </div>
...
function IdentifySigns() {
  ...
  const signs = [
    "Irregular periods after you turn 35 years old",
    "Multiple failed pregnancies that lasted fewer than 21 days on more than one occasion",
    "Signs of hormonal imbalance, such as excess hair growth likely to happen in men",
    "Pain or discomfort in the pelvis or groin area",
    "A strong history of genetic conditions",
  ];
    ...
    <section ref={ref} className="relative w-full overflow-hidden bg-[#FAF5F1]">
      ...
      <div className="relative z-[1] mx-auto grid max-w-6xl grid-cols-1 items-stretch md:grid-cols-2 md:min-h-[680px]">
        ...
        <div className="relative order-2 h-[340px] overflow-hidden md:order-1 md:h-auto">
          <div className="is-img-inner absolute inset-[-8%] w-[116%]">
            <Image src="/services/infertility-signs.jpg" alt="Woman reviewing pregnancy test" fill
              sizes="(min-width:768px) 50vw,100vw" className="object-cover" />
          </div>
          ...
          <div className="is-reveal absolute bottom-6 left-5 max-w-[210px] rounded-2xl p-4 sm:bottom-8 sm:left-7"
            ...
            <div className="mb-1.5 flex items-center gap-1.5">
              ...
              <p className="text-[9.5px] font-bold uppercase tracking-[0.2em]"
                style={{ color: "oklch(0.44 0.1 320)" }}>Know the signs</p>
            </div>
            <p className="text-[11.5px] leading-[1.7]" style={{ color: "#6F665E" }}>
              Early diagnosis and treatment significantly improves fertility outcomes.
            </p>
          </div>
        </div>
        ...
        <div className="order-1 flex flex-col justify-center gap-6 px-7 py-16 md:order-2 md:px-12 md:py-20 lg:px-14">
          <div className="is-reveal"><Eyebrow>Recognising the signs</Eyebrow></div>
          <h2 className="is-reveal font-display leading-[1.05] tracking-[-0.026em]"
            ...
            <em style={{ fontStyle: "italic", color: WARM }}>Female Infertility.</em>
          </h2>
          <div className="is-reveal relative border-l-2 py-1 pl-5"
            style={{ borderColor: "oklch(0.75 0.08 320 / 0.3)" }}>
            <p className="text-[15px] leading-[1.88]" style={{ color: MUTED }}>
              When you've decided you're ready for a baby, every month you don't conceive you can feel anxious or worried. However, it's essential to recognise when signs of infertility may be present. If you have been having regular unprotected sex for a year without getting pregnant, you should consider seeing a specialist. You should also see a reproductive female specialist if you notice any of the following:
            </p>
          </div>
          <ul className="is-reveal flex flex-col gap-2.5">
            {signs.map((s, i) => (
              <li key={i} className="flex items-start gap-3">
                ...
                <span className="text-[13.5px] leading-[1.75]" style={{ color: MUTED }}>{s}</span>
              </li>
            ))}
          </ul>
          <div className="is-reveal">
            <Button variant="primary" href="/contact">Schedule a consultation</Button>
          </div>
        </div>
      </div>
    </section>
...
function Causes() {
  ...
  useEffect(() => {
    const el = ref.current;
    if (!el || typeof window === "undefined") return;
    const intro = gsap.utils.toArray(".ca-intro > *", el);
    const cells = gsap.utils.toArray(".ca-cell", el);
  ...
  const causes = [
    { num: "01", title: "Hormonal Imbalances", body: "Including those related to breastfeeding. Conditions such as polycystic ovary syndrome (PCOS) directly affect hormone levels and ovulation." },
    { num: "02", title: "Diminished Ovarian Reserve", body: "A reduced number or quality of eggs can significantly decrease the chances of natural conception and successful IVF cycles." },
    { num: "03", title: "Polycystic Ovary Syndrome (PCOS)", body: "One of the most common causes of female infertility, PCOS disrupts the regular release of eggs during ovulation." },
    { num: "04", title: "Hyperprolactinemia", body: "Damage to or tumors of the pituitary gland or other autoimmune disease can cause elevated prolactin, which disrupts ovulation." },
    { num: "05", title: "Uterine Developmental Abnormalities", body: "Structural problems with the uterus — including fibroids, polyps, and septums — can prevent implantation or lead to miscarriage." },
    { num: "06", title: "Genetic Conditions", body: "Certain chromosomal abnormalities passed down through families can affect reproductive health and the ability to carry a pregnancy to term." },
  ];
  ...
  return (
    <section ref={ref} className="relative w-full overflow-hidden"
      ...
      <div className="relative z-[1] mx-auto max-w-6xl px-5 py-24 sm:px-8 md:py-28 lg:px-0 lg:py-32">
        <div className="ca-intro mb-14 flex flex-col items-center gap-4 text-center">
          <Eyebrow light>Common causes</Eyebrow>
          <h2 className="font-display leading-[1.05] tracking-[-0.026em] text-white"
            ...
            What Causes Female{" "}
            <em style={{ fontStyle: "italic", color: PINK_L }}>Fertility Problems?</em>
          </h2>
          <p className="max-w-[520px] text-[15px] leading-[1.88]" style={{ color: "oklch(1 0 0 / 0.58)" }}>
            There are all sorts of reasons that people can struggle to conceive sometimes. It's nice to know you can turn to a team of trusted medical professionals. Not all types of fertility issues are related to sexual health — some are medical in nature. The most common causes of fertility problems include:
          </p>
        </div>

        <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
          {/* Featured first cause — wide */}
          <div className="ca-cell group relative overflow-hidden rounded-[24px] p-8 sm:col-span-2 lg:col-span-2"
          ...
          {/* Tall right — causes[1] */}
          <div className="ca-cell group relative overflow-hidden rounded-[24px] p-7 sm:row-span-2"
          ...
          {causes.slice(2).map((c, i) => (
            <div key={i} className="ca-cell group relative overflow-hidden rounded-[24px] p-7"
              style={{ background: "oklch(1 0 0 / 0.05)", border: "1px solid oklch(1 0 0 / 0.09)", boxShadow: "0 2px 8px oklch(0 0 0 / 0.14)", minHeight: "180px" }}>
              <div aria-hidden="true" className="pointer-events-none absolute inset-0 opacity-0 transition-opacity duration-700 group-hover:opacity-100"
                style={{ background: `radial-gradient(ellipse at ${i % 2 === 0 ? "10% 80%" : "90% 80%"},oklch(0.6 0.1 ${i % 2 === 0 ? "150" : "60"} / 0.14),transparent 65%)` }} />
              <span className="mb-5 block text-[11px] font-bold uppercase tracking-[0.22em]"
                style={{ color: "oklch(0.72 0.1 320 / 0.7)" }}>0{i + 3}</span>
...
// ─── 4. TREATMENT OPTIONS — editorial numbered list ──────────────────────────
...
function TreatmentOptions() {
  ...
  useEffect(() => {
    const el = ref.current;
    if (!el || typeof window === "undefined") return;
    const heading = gsap.utils.toArray(".to-head > *", el);
    const rows    = gsap.utils.toArray(".to-row", el);
    const imgs    = gsap.utils.toArray(".to-img", el);
    gsap.set(heading, { opacity: 0, y: 20 });
    gsap.set(rows,    { opacity: 0, y: 22 });
    gsap.set(imgs,    { opacity: 0, scale: 0.96 });
    const base = { ease: "power3.out", scrollTrigger: { trigger: el, start: "top 78%" } };
    ...
    const a3 = gsap.to(imgs,    { opacity: 1, scale: 1, stagger: 0.12, duration: 0.85, delay: 0.08, ease: "power3.out", ...base });
    return () => { [a1, a2, a3].forEach(a => { a.kill(); a.scrollTrigger?.kill(); }); };
  }, []);

  const intro = [
    "Many infertility treatment options start by identifying the cause. It can be a lot easier to address the issue once you know what the problem is. For many gynaecological issues like PCOS, non-hormonal or hormone-containing medications can help to balance hormones, encourage ovulation, and even stimulate ovulation, which helps to conceive.",
    "There are also surgeries that can help. If the fertility issues are linked to some sort of physical malformation, for example, if you're struggling to conceive due to a fallopian tube obstruction, surgery can remove the root cause and make it easier to conceive.",
    "A third option is assisted reproduction. This helps to unite an egg and a sperm in more controlled circumstances and increase the chance of conception. Assisted reproduction comes in many forms.",
  ];
  ...
  const treatments = [
    {
      ...
      body: "IUI is a procedure that involves collecting a sperm sample and selecting the most potent sperm. These are then inserted directly into the uterus, putting them in close contact with the egg.",
    },
    {
      num: "02",
      label: "In Vitro Fertilization (IVF)",
      body: "IVF involves collecting an egg and a sperm sample and combining them in a lab setting. The resulting embryo can then be implanted into the womb.",
    },
    {
      num: "03",
      label: "Egg or Sperm Donors",
      body: "It is possible to use donor genetic material if you or your partner does not have viable eggs or sperm. Combined with IUI or IVF, this can help people to conceive.",
    },
  ];
  ...
  return (
    <section ref={ref} className="relative w-full overflow-hidden bg-[#FAF5F1]">
      ...
      <div className="relative z-[1] mx-auto max-w-6xl px-5 py-24 sm:px-8 md:py-28 lg:px-0 lg:py-32">
        <div className="to-head mb-12 grid grid-cols-1 gap-8 md:grid-cols-2 md:items-end">
          <div className="flex flex-col gap-4">
            <Eyebrow>Your treatment options</Eyebrow>
            <h2 className="font-display leading-[1.05] tracking-[-0.026em]"
              ...
              Explore Infertility{" "}
              <em style={{ fontStyle: "italic", color: WARM }}>Treatment Options.</em>
            </h2>
          </div>
          <p className="max-w-[360px] text-[14.5px] leading-[1.88] md:ml-auto md:text-right" style={{ color: MUTED }}>
            A personalised plan tailored to your specific condition and goals —
            compassionate care at every step.
          </p>
        </div>

        {/* Intro paragraphs */}
        <div className="to-head mb-10 flex flex-col gap-4">
          {intro.map((p, i) => (
            <p key={i} className="max-w-[860px] text-[14.5px] leading-[1.9]" style={{ color: MUTED }}>{p}</p>
          ))}
        </div>

        {/* 3-col treatment cards */}
        <div className="mb-12 grid grid-cols-1 gap-4 sm:grid-cols-3">
          {treatments.map((t, i) => (
            <div key={i} className="to-img group relative overflow-hidden rounded-[24px] p-7 transition-all duration-500 hover:-translate-y-1.5"
              style={{ background: "rgba(255,255,255,0.78)", backdropFilter: "blur(14px)", WebkitBackdropFilter: "blur(14px)", border: "1px solid oklch(0.86 0.04 320 / 0.22)", boxShadow: "0 2px 6px oklch(0.3 0.05 320 / 0.04),0 12px 32px oklch(0.3 0.05 320 / 0.06)" }}>
              <span className="mb-4 block text-[11px] font-bold uppercase tracking-[0.22em]"
                style={{ color: "oklch(0.58 0.1 320 / 0.6)" }}>{t.num}</span>
              <h3 className="font-display text-[1.1rem] font-semibold leading-snug tracking-[-0.01em]"
                style={{ fontFamily: "var(--font-display,'Playfair Display',serif)", color: DARK }}>
                {t.label}
              </h3>
              <div className="my-3 h-px"
                style={{ background: "oklch(0.78 0.06 320 / 0.22)" }} />
              <p className="text-[13px] leading-[1.84]" style={{ color: MUTED }}>{t.body}</p>
            </div>
          ))}
        </div>
        ...
        <div className="flex flex-col">
          {[
            {
              label: "Medication & Hormone Therapy",
              body: "The first line of treatment for many causes of infertility. Clomiphene citrate, letrozole, and gonadotropins can stimulate ovulation. Metformin is commonly used for PCOS-related infertility.",
            },
            {
              label: "Surgical Intervention",
              body: "If structural abnormalities like blocked fallopian tubes, fibroids, polyps, or endometriosis are identified, minimally invasive laparoscopic surgery can correct these issues and restore natural fertility.",
            },
            {
              label: "Intrauterine Insemination (IUI)",
              body: "A low-intervention assisted reproduction option where specially prepared sperm is placed directly into the uterus around the time of ovulation to increase the chance of fertilisation.",
            },
            {
              label: "In Vitro Fertilization (IVF)",
              body: "Eggs are retrieved, fertilised in a laboratory setting, and resulting embryos are assessed before the best candidate is transferred to the uterus. Success rates continue to improve with advances in reproductive medicine.",
            },
            {
              label: "Donor Eggs or Sperm",
              body: "When viable eggs or sperm are unavailable, donor genetic material combined with IUI or IVF provides a path to parenthood. Our team guides you through every legal and medical consideration.",
            },
          ].map((s, i) => (
            <div key={i} className="to-row group relative grid cursor-default grid-cols-[3rem_1fr] items-start gap-x-6 border-t py-6 transition-all duration-300 md:grid-cols-[3.5rem_1fr_1fr] md:items-center md:gap-x-10 md:py-7"
...
function Testimonials() {
  ...
  const quotes = [
    ...
    {
      q: "Didn't have a long wait, saw the PA and she was great. New patient, although I have known Dr. for a few years. Lovely office and great visit.",
      name: "Kathleen C.",
      when: "Patient",
    },
  ];
    ...
    <section ref={ref} className="relative w-full overflow-hidden"
      ...
      <div className="cta-inner relative z-[1] mx-auto flex max-w-2xl flex-col items-center gap-5 px-5 py-24 text-center sm:px-8 md:py-28">
        ...
        <p className="max-w-[460px] text-[15px] leading-[1.88]" style={{ color: MUTED }}>
          At Women's Care of Bradenton, we provide compassionate, dedicated care. Our team works hard to identify the causes of fertility issues and plan appropriate treatments. Schedule an appointment at our infertility clinic in Bradenton, FL today.
        </p>
        <div className="flex flex-wrap items-center justify-center gap-3">
          <Button variant="primary" href="/contact">Book a consultation</Button>
